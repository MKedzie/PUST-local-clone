...
if strcmp(Regulator,'PID')
    ...
    Ti = TDrgan*0.3;
    Td = TDrgan*0.15;
%     nazwa = "data/zad4P_PID_10_03_15_mnozonerazy100_.txt";
%     K = KKryt * 0.4;
%     Ti = TDrgan*0.4;
%     Td = TDrgan*0.12;
    T = 0.5;
...
% nazwa = "data/zad5P_DMC_"+num2str(D)+"_"+num2str(N)+"_"+num2str(Nu)+"_"+num2str(lambda) + "_"+Estr+".txt";
% nazwau = "data/zad5P_DMC_"+num2str(D)+"_"+num2str(N)+"_"+num2str(Nu)+"_"+num2str(lambda) + "_"+Estr+"_u.txt";
